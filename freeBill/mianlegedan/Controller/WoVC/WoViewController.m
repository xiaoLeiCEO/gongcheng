...
//            [self.navigationController pushViewController:myCommentVC animated:YES];
            ...
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"客服电话" message:@"0000-1111-222" preferredStyle:UIAlertControllerStyleAlert];
