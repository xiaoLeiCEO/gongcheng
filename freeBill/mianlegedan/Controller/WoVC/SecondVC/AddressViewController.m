...
- (void)viewDidLoad {
    ...
    self.title = @"收货地址";
    //注册通知
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadTableData:) name:@"addAddress" object:nil];
    [self setTableView];
...
-(void)reloadTableData:(NSNotification *)dict{
