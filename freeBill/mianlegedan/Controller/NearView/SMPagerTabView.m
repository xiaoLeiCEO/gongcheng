...
//        CGFloat itemButtonWidth = (self.width - self.tabMargin*2)/number;
        ...
        [itemButton setFrame:CGRectMake(width*i, 0, width, self.tabFrameHeight)];
//        itemButton.backgroundColor = [UIColor yellowColor];
        ...
        aRedDot.backgroundColor = [ViewUtil hexColor:@"#fe566d"];
...
- (UIView *)selectedLine {
    if (!_selectedLine) {
        ...
        _selectedLine.backgroundColor = [ViewUtil hexColor:@"#fe566d"];
...
- (CGFloat)selectedLineWidth {
    if (!_selectedLineWidth) {
        self.selectedLineWidth = screen_width *0.2-10;
    }
