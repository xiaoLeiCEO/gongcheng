...
//    NSDictionary *shopDict = dict.userInfo;
//
...
-(void)setNav{
    ...
    backView.backgroundColor = [ViewUtil hexColor:@"#f0f0f0"];
    [self.view addSubview:backView];
    //城市
    UIButton *cityBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    cityBtn.frame = CGRectMake(10, 30, 60, 25);
    ...
    [cityBtn setTitleColor:[ViewUtil hexColor:@"#666666"] forState:UIControlStateNormal];
    ...
    //搜索框
    UIView *searchView = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(arrowImage.frame)+10, 30, screen_width-110, 25)];
