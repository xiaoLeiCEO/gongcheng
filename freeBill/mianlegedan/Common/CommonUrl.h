...
#define DOMAINURL @"http://www.mianlegedan.com"
#define IMGURL @"http://www.mianlegedan.com/"
#define IMGFORJAVAURL @"http://oms.mianlegedan.com"
...
// 模糊搜索
#define FBFUWUNearLikeSearchUrl kAbs(IMGFORJAVAURL,@"/hd/Android/fuWumingCheng")
// 积分商城
