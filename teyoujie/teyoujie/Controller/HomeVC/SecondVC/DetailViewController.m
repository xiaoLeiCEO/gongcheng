...
//    self.navigationController.navigationBarHidden = YES;
    ...
    /*
    AddGoodsCarView *addView = [[[NSBundle mainBundle]loadNibNamed:@"AddGoodsCarView" owner:self options:nil]lastObject];
    [addView.addGoodsCarBtn addTarget:self action:@selector(addGoodsCarAction) forControlEvents:UIControlEventTouchUpInside];
    addView.frame = CGRectMake(0, screen_height-50, screen_width, 50);
    [self.view addSubview:addView];
     */
    }
     
     /*
-(void)addGoodsCarAction{
    GoodsCarViewController *goodsVC = [[GoodsCarViewController alloc]init];
...
//    _tableView.hidden = YES;
    ...
    [headerView.detailImgView sd_setImageWithURL:[NSURL URLWithString:urlStr] placeholderImage:[UIImage imageNamed:@"placeImg"]];
