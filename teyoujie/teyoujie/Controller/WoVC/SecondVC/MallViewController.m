...
-(void)btnAction:(UIButton *)btn {
        if (btn.tag == 501) {
            //积分兑换记录
            JiFenRecordViewController *jiFenRecordVC = [[JiFenRecordViewController alloc]init];
            [self.navigationController pushViewController:jiFenRecordVC animated:YES];
        } else {
            //积分规则
