...
//    NSString *imgUrl = shopRecM.imgurl;
    [_shopImageView sd_setImageWithURL:[NSURL URLWithString: [IMGURL stringByAppendingString:shopRecM.goods_thumb]] placeholderImage:[UIImage imageNamed:@"placeImg"]];
